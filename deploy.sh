...
PROJECT_DIR="/var/www/ktmsubject.com"
GIT_REPO="https://github.com/2508roblox/4tr_ql_mon_hoc.git"
SQL_FILE="${PROJECT_DIR}/monhoc.sql"
DB_NAME="ktmsubject"
DB_USER="ktmsubject"
DB_PASSWORD="ktmsubjectktmsubject"  # Thay đổi mật khẩu nếu cần
